...
| 10 | P1 | Minimal run API and dashboard pipeline view | IN PROGRESS — Day 29 authenticated Runner transport boundary complete; Windows worker orchestration remains |
