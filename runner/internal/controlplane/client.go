...
var (
	...
	detailPolicies     = map[string]struct {
		...
		"endpoint_evidence_limit":     {stage: "endpoint_telemetry", status: "failed"},
		"endpoint_query_failed":       {stage: "endpoint_telemetry", status: "failed"},
		"endpoint_xml_invalid":        {stage: "endpoint_telemetry", status: "failed"},
		"endpoint_observer_failed":    {stage: "endpoint_telemetry", status: "failed"},
